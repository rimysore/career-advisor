 ...
 */
function extractResumeText(fileContent) {
  try {
...
function calculateATSScore(resumeText) {
  ...
  if (resumeText.match(/\d+\s*(years?|yrs?)/i)) {
    score += 10; // Mentions years of experience
  }
